...
export default {
    ...
    methods: {
              ...
              if(this.model.tahun >= 2000 && this.model.tahun <= (new Date()).getFullYear())
              {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/pp-bekerja/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/pp-bekerja/create'
                  }
                },
                window.location.href = '#/admin/pp-bekerja/create')
        ...
        back() {
            window.location = '#/admin/pp-bekerja';
        }
    },
    mounted: function() {
        axios.get("/pp-bekerja/create").then(response => {
